...
using CERAXLAN.Core.CrossCuttingConcerns.Exceptions.Handlers;
using CERAXLAN.Core.CrossCuttingConcerns.Logging;
using CERAXLAN.Core.CrossCuttingConcerns.Logging.Serilog;
using Microsoft.AspNetCore.Http;
using Newtonsoft.Json;

namespace CERAXLAN.Core.CrossCuttingConcerns.Exceptions
{
